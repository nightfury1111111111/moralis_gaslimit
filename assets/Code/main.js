const serverUrl = "https://kzktn5rmi0c2.usemoralis.com:2053/server"; //Server url from moralis.io
...
function openModal(side) {
  ...
  document.getElementById("p_to_hide").style.display = "none";
}
function closeModal() {
...
document.getElementById("to_token_select").onclick = () => {
  openModal("to");
  document.getElementById("p_to_show").style.display = "none";
};
